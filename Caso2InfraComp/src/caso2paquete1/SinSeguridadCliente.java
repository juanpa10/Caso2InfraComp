...
public class SinSeguridadCliente 

{
	...
	public SinSeguridadCliente(String ip, int puerto,BufferedReader br,int cod,int numUsuariosConcuurentes, Csv reportar)
	{
		terminoBien=true;
		aReportar=reportar;
		codigAct=cod;
...
//            Cliente cliente= new Cliente(s, i,br);
        	Csv nuvo= new Csv(1, "prueba");
        	SinSeguridadCliente clienteA= new SinSeguridadCliente("localhost", 4567,br,1,1,nuvo);
        	try {
				clienteA.inicarComunicacion("holi");
			} catch (Exception e) {
				// TODO Auto-generated catch block
				e.printStackTrace();
			}
